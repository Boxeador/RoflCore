...
(23543,1,0,'Seid bereit! Die Stunde hat geschlagen. Versteckt eure Alten, Kranken und Plagen. Ein jeder von euch zahlt den letzten Preis. Es gibt kein erbarmen. So schließt sich der Kreis.',14,0,100,1,0,11966,'Shade of the Horseman - Horseman Bomb'),
(23543,2,0,'Meine Flammen sind vergangen. Ihr habt es vollbracht! So treibe ich euch selbst in die Leere der Nacht!',14,0,100,1,0,11968,'Shade of the Horseman - Horseman Out'),
(23543,3,0,'Feuer verzerrt und ihr unterliegt. Es gibt keine Zweifel. Die Gerechtigkeit sieht!',14,0,100,1,0,11967,'Shade of the Horseman - Horseman Fire'),
(23543,4,0,'<%s lacht>',16,0,100,11,0,11975,'Shade of the Horseman - Laugh1'),
(23543,4,1,'<%s lacht>',16,0,100,11,0,12119,'Shade of the Horseman - Laugh2'),
(23543,5,0,"Mein Blut bringt den Sieg, so habt ihr geglaubt, doch um wirklich zu siegen, müsst ihr töten mein Haupt.", 14,0,100,1,0,11969,'shade say death');